...
class ImageBox extends Component
{
    ...
    {        
        $this->requireCss('/__OsynapsyAsset/Bcl/ImageBox2/style.css');
        $this->requireCss('/__OsynapsyAsset/Bcl/ImageBox2/cropper.css');
        $this->requireJs('/__OsynapsyAsset/Bcl/ImageBox2/cropper.js');
        $this->requireJs('/__OsynapsyAsset/Bcl/ImageBox2/script.js');
